...
# NEUE Farben für Supervisor Logistik-Karte Visualisierung
...
# Die folgenden zwei sind für die interne Logistik-Karte des Supervisors
...
KEY_VIEW_SUPERVISOR_LOGISTICS = pygame.K_p # Taste: ' (neben Enter) für Logistik-Karte
...
KEY_VIEW_AGENT_8 = pygame.K_8 # Hinzugefügt
KEY_VIEW_AGENT_9 = pygame.K_9 # Hinzugefügt
...
MIN_EXPLORE_TARGET_SEPARATION = 15
...
# Folgende spezifische Supervisor-Heuristik-Configs wurden entfernt,
# da die Logik im SupervisorAgent internalisiert wurde:
# MAX_INITIAL_SUPERVISOR_HOTSPOT_TASKS
# SUPERVISOR_EARLY_EXPLORATION_UNKNOWN_THRESHOLD_PERCENT
# SUPERVISOR_EARLY_EXPLORATION_DISTANCE_WEIGHT
# FALLBACK_FRONTIER_CANDIDATE_CHECK_COUNT
# RANDOM_CHOICE_AMONG_TOP_N_FRONTIERS

# Worker Kaskaden-Exploration Configs (nicht mehr genutzt durch Supervisor-Worker)
# CHAINED_EXPLORATION_STEP_BUDGET = 75
# MAX_CHAINED_FRONTIERS_VISITED = 5
# CHAINED_LOCAL_EXPLORE_STEPS = 2